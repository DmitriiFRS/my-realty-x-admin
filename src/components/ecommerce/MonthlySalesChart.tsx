...
export default function MonthlySalesChart({ token }: { token: string | undefined }) {
   const { data, isLoading, error } = useFetchData<number[]>('admin-analytics/estates-monthly', token);
   ...
   return (
      <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white px-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6">
         <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white/90">Объявлений за год</h3>
