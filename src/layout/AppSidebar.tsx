...
const navItems: NavItem[] = [
   {
      icon: <GridIcon />,
      name: 'Главная',
      // subItems: [{ name: 'Статистика', path: '/', pro: false }],
      path: '/',
   },
   {
      name: 'Объявления',
         ...
         <div className={`py-8 flex  ${!isExpanded && !isHovered ? 'lg:justify-center' : 'justify-start'}`}>
            <Link href="/">
               {isExpanded || isHovered || isMobileOpen ? (
                  ...
                  <Image src="/images/logo/logo-mini.png" alt="Logo" width={30} height={30} quality={100} />
               )}
            </Link>
         </div>
            ...
            <nav className="mb-6">
               <div className="flex flex-col gap-4">
                  <div>
                     ...
                     >
                        {isExpanded || isHovered || isMobileOpen ? 'Меню' : <HorizontaLDots />}
                     </h2>
